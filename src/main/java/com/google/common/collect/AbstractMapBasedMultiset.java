...
abstract class AbstractMapBasedMultiset<E> extends AbstractMultiset<E> implements Serializable {
	 ...
	 *
	 * <p>
	 * Invoking {@link Entry#getCount} on an entry in the returned set always
	 * returns the current count of that element in the multiset, as opposed to the
	 * count at the time the entry was retrieved.
	 */
	@Override
