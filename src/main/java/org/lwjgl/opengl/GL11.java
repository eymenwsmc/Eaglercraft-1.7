...
public class GL11 extends EaglercraftGPU {
	...
	public static void glFinish() {
		EaglercraftGPU.finish();
	}

	public static void glEnableClientState(int array) {
		PlatformOpenGL._wglEnableClientState(array);
	}

	public static void glDisableClientState(int array) {
		PlatformOpenGL._wglDisableClientState(array);
	}

	public static void glVertexPointer(int size, int type, FloatBuffer buffer) {
		PlatformOpenGL._wglVertexAttribPointer(0, size, type, false, 0, 0);
		// Not: buffer binding zaten önceden yapılmış olmalı
	}

	public static void glVertexPointer(int size, int type, int stride, long pointer) {
		PlatformOpenGL._wglVertexAttribPointer(0, size, type, false, stride, (int) pointer);
	}

	public static void glColorPointer(int size, boolean unsigned, int stride, ByteBuffer buffer) {
		PlatformOpenGL._wglVertexAttribPointer(1, size, unsigned ? /* UNSIGNED_BYTE */ 0x1401 : /* BYTE */ 0x1400,
				false, stride, 0);
	}

	public static void glColorPointer(int size, int type, int stride, long pointer) {
		PlatformOpenGL._wglVertexAttribPointer(1, size, type, false, stride, (int) pointer);
	}

	public static void glTexCoordPointer(int size, int type, FloatBuffer buffer) {
		PlatformOpenGL._wglVertexAttribPointer(2, size, type, false, 0, 0);
	}

	public static void glTexCoordPointer(int size, int type, ShortBuffer buffer) {
		PlatformOpenGL._wglVertexAttribPointer(2, size, type, false, 0, 0);
	}

	public static void glTexCoordPointer(int size, int type, int stride, long pointer) {
		PlatformOpenGL._wglVertexAttribPointer(2, size, type, false, stride, (int) pointer);
	}

	public static void glNormalPointer(int type, ByteBuffer buffer) {
		PlatformOpenGL._wglVertexAttribPointer(3, 3, type, false, 0, 0);
	}

	public static void glNormalPointer(int type, int stride, long pointer) {
		PlatformOpenGL._wglVertexAttribPointer(3, 3, type, false, stride, (int) pointer);
	}
}