...
public class ArrayUtils {
	...
	/**
	 * A fluent version of {@link System#arraycopy(Object, int, Object, int, int)}
	 * that returns the destination array.
	 *
	 * @param <T>       the type.
	 ...
	 *                                   <code>dest</code> array because of a type
	 *                                   mismatch.
	 * @throws NullPointerException      if either <code>src</code> or
	 *                                   <code>dest</code> is <code>null</code>.
	 * @since 3.15.0
	 */
	public static <T> T arraycopy(final T source, final int sourcePos, final int destPos, final int length,
			final Function<Integer, T> allocator) {
	 ...
	 * @since 3.15.0
	 */
	public static <T> T arraycopy(final T source, final int sourcePos, final T dest, final int destPos,
			final int length) {
