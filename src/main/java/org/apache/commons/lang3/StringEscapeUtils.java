...
public class StringEscapeUtils {
	...
	public static final CharSequenceTranslator UNESCAPE_JAVA = new AggregateTranslator(new OctalUnescaper(),
			/* .between('\1', '\377'), */ new UnicodeUnescaper(),
			new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_UNESCAPE()),
			new LookupTranslator(new String[][] { { "\\\\", "\\" }, { "\\\"", "\"" }, { "\\'", "'" }, { "\\", "" } }));

	/**
	 * Unescapes any Java literals found in the {@link String}. For example, it will
