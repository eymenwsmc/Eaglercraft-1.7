 ...
 * whenever the first translator consumes code points from the input.
 *
 * @since 3.0 <a href=
 *        "https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/translate/AggregateTranslator.html">
