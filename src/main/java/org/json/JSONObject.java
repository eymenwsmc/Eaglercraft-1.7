...
public class JSONObject {
	 ...
	 *
	 * @param m                       A map object that can be used to initialize
...
// Shave off trailing zeros and decimal point, if possible.
	 ...
	 *                       JSONArray.
	 */
	public JSONArray getJSONArray(String key, JSONArray optional) throws JSONException {
		Object object = this.get(key);
		if (object instanceof JSONArray) {
			return (JSONArray) object;
		}
	 ...
	 * there is no such key, or if the value is not Boolean.TRUE or the String
	 * "true".
	 *
	 * @param key A key string.
	 * @return The truth.
	 ...
	 * defaultValue if there is no such key, or if it is not a Boolean or the String
	 ...
	 * such key or if its value is not a number. If the value is a string, an
	 * attempt will be made to evaluate it as a number.
	 *
	 * @param key A string which is the key.
	 * @return An object which is the value.
	 ...
	 * is no such key or if the value is not a number. If the value is a string, an
	 * attempt will be made to evaluate it as a number.
	 *
	 * @param key          A key string.
	 * @param defaultValue The default.
	...
	/**
	 * Get an optional JSONArray associated with a key, or the default if there is
	 * no such key, or if its value is not a JSONArray.
	 *
	 * @param key          A key string.
	 * @param defaultValue The default.
	...
	/**
	 * Get an optional Long object associated with a key, or the default if there is
	 * no such key or if the value is not a number. If the value is a string, an
	 * attempt will be made to evaluate it as a number.
	 *
	 * @param key          A key string.
