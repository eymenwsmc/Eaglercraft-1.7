...
public class ParserConfiguration {
	...
	/**
	 * Specifies if values should be kept as strings (<code>true</code>), or if they
	 * should try to be guessed into JSON values (numeric, boolean, string)
	 */
	 ...
	 * strings (<code>true</code>), or if they should try to be guessed into JSON
	 * values (numeric, boolean, string)
	 *
	 ...
	 * throwing an exception when parsing the XML into JSONML. The default max
	 * nesting depth is 512, which means the parser will throw a JsonException if
