...
public class JSONArray implements Iterable<Object> {
	 ...
	 *
	 * @param collection              A Collection.
	 * @param recursionDepth          Variable for tracking the count of nested
	 *                                object creations.
	 * @param jsonParserConfiguration Configuration object for the JSON parser
	 */
	...
	public <E extends Enum<E>> E getEnum(Class<E> clazz, int index) throws JSONException {
		...
		if (val == null) {
			...
			throw wrongValueFormatException(index, "enum of type " + JSONObject.quote(clazz.getSimpleName()),
					opt(index), null);
		}
		return val;
	}
	...
	/**
	 * Get the optional Boolean object associated with an index. It returns false if
	 * there is no value at that index, or if the value is not Boolean.TRUE or the
	 * String "true".
	 *
	 * @param index The index must be between 0 and length() - 1.
	...
	/**
	 * Get the optional Double object associated with an index. NaN is returned if
	 * there is no value for the index, or if the value is not a number and cannot
	 * be converted to a number.
	 *
	 * @param index The index must be between 0 and length() - 1.
	...
	/**
	 * Get the optional Float object associated with an index. NaN is returned if
	 * there is no value for the index, or if the value is not a number and cannot
	 * be converted to a number.
	 *
	 * @param index The index must be between 0 and length() - 1.
	...
	/**
	 * Get the optional Float object associated with an index. The defaultValue is
	 * returned if there is no value for the index, or if the value is not a number
	 * and cannot be converted to a number.
	 *
	 * @param index        subscript
	 ...
	 * the {@link BigDecimal#BigDecimal(double)} constructor will be used. See notes
	 * on the constructor for conversion issues that may arise.
	 *
	 * @param index        The index must be between 0 and length() - 1.
	 * @param defaultValue The default value.
	 * @return The value.
	 ...
	 * returned if there is no value at that index or if the value is not a
	 * JSONArray.
	 *
	 * @param index        The index must be between 0 and length() - 1.
	 ...
	 *
	 * @param collection     A Collection.
	 * @param wrap           {@code true} to call {@link JSONObject#wrap(Object)}
	 *                       for each item, {@code false} to add the items directly
	 * @param recursionDepth Variable for tracking the count of nested object
	 *                       creations.
	 */
	 ...
	 * Add an array's elements to the JSONArray.
	 *
	 * @param array          Array. If the parameter passed is null, or not an
	 *                       array, JSONArray, Collection, or Iterable, an exception
	 *                       will be thrown.
	 * @param wrap           {@code true} to call {@link JSONObject#wrap(Object)}
	 *                       for each item, {@code false} to add the items directly
	 * @param recursionDepth Variable for tracking the count of nested object
