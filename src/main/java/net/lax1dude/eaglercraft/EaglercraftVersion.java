...
public class EaglercraftVersion {
	...
	public static final String updateBundlePackageName = "net.lax1dude.eaglercraft.client";
	...
	public static final String mainMenuStringA = "Minecraft 1.7.10";
	...
	public static final String screenRecordingFilePrefix = projectOriginName + " " + projectOriginRevision + "-"
