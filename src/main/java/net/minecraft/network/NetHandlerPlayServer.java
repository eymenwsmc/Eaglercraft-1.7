...
import net.lax1dude.eaglercraft.socket.protocol.message.MessageController;
...
public class NetHandlerPlayServer implements INetHandlerPlayServer {
	...
	public NetHandlerPlayServer(MinecraftServer p_i1530_1_, IntegratedServerPlayerNetworkManager p_i1530_2_,
			EntityPlayerMP p_i1530_3_) {
	...
	public IntegratedServerPlayerNetworkManager func_147362_b() {
	...
	public void processInput(C0CPacketInput p_147358_1_) {
		this.playerEntity.setEntityActionState(p_147358_1_.func_149620_c(), p_147358_1_.func_149616_d(),
	...
	public void processPlayer(C03PacketPlayer p_147347_1_) {
		...
		if (!this.playerEntity.playerConqueredTheEnd) {
			...
			if (!this.hasMoved) {
				...
				if (p_147347_1_.func_149464_c() == this.lastPosX && var3 * var3 < 0.01D
	...
	public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement p_147346_1_) {
		try {
			logger.info("[PLACE] pos=({}, {}, {}), face={}, heldItem={}, hit=({}, {}, {})", p_147346_1_.func_149576_c(),
					p_147346_1_.func_149571_d(), p_147346_1_.func_149570_e(), p_147346_1_.func_149568_f(),
					p_147346_1_.func_149574_g() != null ? p_147346_1_.func_149574_g().getDisplayName() : "null",
					p_147346_1_.func_149573_h(), p_147346_1_.func_149569_i(), p_147346_1_.func_149575_j());
		} catch (Throwable t) {
			logger.info("[PLACE] log failed", t);
		}
		WorldServer var2 = this.serverController.worldServerForDimension(this.playerEntity.dimension);
		...
		if (p_147346_1_.func_149568_f() == 255) {
			...
			if (this.hasMoved
				...
				this.playerEntity.theItemInWorldManager.activateBlockOrUseItem(this.playerEntity, var2, var3, var5,
						var6, var7, var8, p_147346_1_.func_149573_h(), p_147346_1_.func_149569_i(),
	...
	public void sendPacket(final Packet p_147359_1_) {
		...
		try {
			this.netManager.sendPacket(p_147359_1_);
	...
	public void processEntityAction(C0BPacketEntityAction p_147357_1_) {
		...
		} else if (p_147357_1_.func_149513_d() == 7 && this.playerEntity.ridingEntity != null
	...
	public void processClientStatus(C16PacketClientStatus p_147342_1_) {
		...
		case 1:
			if (this.playerEntity.playerConqueredTheEnd) {
				this.playerEntity = this.serverController.getConfigurationManager().respawnPlayer(this.playerEntity, 0,
						true);
	...
	public void processClickWindow(C0EPacketClickWindow p_147351_1_) {
		...
		if (this.playerEntity.openContainer.windowId == p_147351_1_.func_149548_c()
				&& this.playerEntity.openContainer.isPlayerNotUsingContainer(this.playerEntity)) {
			ItemStack var2 = this.playerEntity.openContainer.slotClick(p_147351_1_.func_149544_d(),
					p_147351_1_.func_149543_e(), p_147351_1_.func_149542_h(), this.playerEntity);
	...
	public void processEnchantItem(C11PacketEnchantItem p_147338_1_) {
		...
		if (this.playerEntity.openContainer.windowId == p_147338_1_.func_149539_c()
				&& this.playerEntity.openContainer.isPlayerNotUsingContainer(this.playerEntity)) {
	...
	public void processCreativeInventoryAction(C10PacketCreativeInventoryAction p_147344_1_) {
		...
		try {
			logger.info("[CREATIVE] slot={}, item={}, size={}", p_147344_1_.func_149627_c(),
					p_147344_1_.func_149625_d() != null ? p_147344_1_.func_149625_d().getDisplayName() : "null",
					p_147344_1_.func_149625_d() != null ? p_147344_1_.func_149625_d().stackSize : -1);
		} catch (Throwable t) {
			logger.info("[CREATIVE] log failed", t);
		}
		if (this.playerEntity.theItemInWorldManager.isCreative()) {
			...
			boolean var4 = p_147344_1_.func_149627_c() >= 1
					&& p_147344_1_.func_149627_c() < 36 + InventoryPlayer.getHotbarSize();
	...
	public void processConfirmTransaction(C0FPacketConfirmTransaction p_147339_1_) {
		...
		if (var2 != null && p_147339_1_.func_149533_d() == var2.shortValue()
				&& this.playerEntity.openContainer.windowId == p_147339_1_.func_149532_c()
				&& !this.playerEntity.openContainer.isPlayerNotUsingContainer(this.playerEntity)) {
	...
	public void processUpdateSign(C12PacketUpdateSign p_147343_1_) {
		...
		if (var2.blockExists(p_147343_1_.func_149588_c(), p_147343_1_.func_149586_d(), p_147343_1_.func_149585_e())) {
			TileEntity var3 = var2.getTileEntity(p_147343_1_.func_149588_c(), p_147343_1_.func_149586_d(),
	...
	public void processTabComplete(C14PacketTabComplete p_147341_1_) {
		...
		Iterator var3 = this.serverController.getPossibleCompletions(this.playerEntity, p_147341_1_.func_149419_c())
				.iterator();
