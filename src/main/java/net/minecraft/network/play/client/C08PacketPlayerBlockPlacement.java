...
public class C08PacketPlayerBlockPlacement extends Packet {
	...
	public void writePacketData(PacketBuffer p_148840_1_) throws IOException {
		...
		int _hx = (int) (this.field_149577_f * 16.0F);
		int _hy = (int) (this.field_149578_g * 16.0F);
		int _hz = (int) (this.field_149584_h * 16.0F);
		if (_hx < 0)
			_hx = 0;
		else if (_hx > 15)
			_hx = 15;
		...
		if (_hz < 0)
			...
			_hz = 15;
		p_148840_1_.writeByte(_hx);
		p_148840_1_.writeByte(_hy);
		p_148840_1_.writeByte(_hz);
	}
