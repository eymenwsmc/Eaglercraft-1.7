...
public abstract class Packet<T extends INetHandler> {
	 ...
	 * by prefixing the byte array with its length
	 */
	 ...
	 * will be interpreted as the size of the byte array to read in
	 */
