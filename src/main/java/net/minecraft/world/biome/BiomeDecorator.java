	...
	protected void func_150513_a(BiomeGenBase p_150513_1_) {
		...
		if (this.generateLakes) {
			...
			for (int k5 = 0; k5 < 2; ++k5) {
				...
				int y = this.currentWorld.getTopSolidOrLiquidBlock(i10, l13);
				if (y > 0) {
					(new WorldGenLiquids(Blocks.flowing_water)).generate(this.currentWorld, this.randomGenerator, i10,
							y, l13);
				}
			}
			...
			for (int l5 = 0; l5 < 1; ++l5) {
				...
				int i14 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				int y = this.currentWorld.getTopSolidOrLiquidBlock(j10, i14);
				if (y > 0) {
					(new WorldGenLiquids(Blocks.flowing_lava)).generate(this.currentWorld, this.randomGenerator, j10, y,
							i14);
				}
			}
		}
