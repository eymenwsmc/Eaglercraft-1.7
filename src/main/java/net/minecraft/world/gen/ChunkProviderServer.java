...
public class ChunkProviderServer implements IChunkProvider {
	 ...
	 * or if the center of the chunk is outside 200 blocks (x or z) of the spawn
	 */
	...
	public boolean func_177460_a(IChunkProvider ichunkprovider, Chunk chunk, int i, int j) {
		if (this.currentChunkProvider != null && this.currentChunkProvider.func_177460_a(ichunkprovider, chunk, i, j)) {
