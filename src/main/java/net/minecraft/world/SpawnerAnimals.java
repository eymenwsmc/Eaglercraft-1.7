...
public final class SpawnerAnimals {
	...
	public int findChunksForSpawning(WorldServer p_77192_1_, boolean p_77192_2_, boolean p_77192_3_,
		...
		if (!p_77192_2_ && !p_77192_3_) {
			...
			for (int var36 = 0; var36 < var8; ++var36) {
				...
				if ((!var37.getPeacefulCreature() || p_77192_3_) && (var37.getPeacefulCreature() || p_77192_2_)
						&& (!var37.getAnimal() || p_77192_4_)
						&& p_77192_1_.countEntities(var37.getCreatureClass()) <= var37.getMaxNumberOfCreature()
					...
					while (var38.hasNext()) {
						...
						if (!((Boolean) this.eligibleChunksForSpawning.get(var39)).booleanValue()) {
							...
							if (!p_77192_1_.getBlock(var14, var15, var16).isNormalCube() && p_77192_1_
									.getBlock(var14, var15, var16).getMaterial() == var37.getCreatureMaterial()) {
								int var17 = 0;
								int var18 = 0;
								...
								while (var18 < 3) {
									...
									while (true) {
										if (var25 < 4) {
											label103: {
												var19 += p_77192_1_.rand.nextInt(var22)
														- p_77192_1_.rand.nextInt(var22);
												var20 += p_77192_1_.rand.nextInt(1) - p_77192_1_.rand.nextInt(1);
												var21 += p_77192_1_.rand.nextInt(var22)
														- p_77192_1_.rand.nextInt(var22);

												if (canCreatureTypeSpawnAtLocation(var37, p_77192_1_, var19, var20,
														var21)) {
	...
	public static boolean canCreatureTypeSpawnAtLocation(EnumCreatureType p_77190_0_, World p_77190_1_, int p_77190_2_,
		...
		if (p_77190_0_.getCreatureMaterial() == Material.water) {
			...
			return var5 != Blocks.bedrock && !p_77190_1_.getBlock(p_77190_2_, p_77190_3_, p_77190_4_).isNormalCube()
		...
		if (!var7.isEmpty()) {
			while (p_77191_6_.nextFloat() < p_77191_1_.getSpawningChance()) {
				BiomeGenBase.SpawnListEntry var8 = (BiomeGenBase.SpawnListEntry) WeightedRandom
						.getRandomItem(p_77191_0_.rand, var7);
				...
				for (int var15 = 0; var15 < var10; ++var15) {
					...
					for (int var17 = 0; !var16 && var17 < 4; ++var17) {
						...
						if (canCreatureTypeSpawnAtLocation(EnumCreatureType.creature, p_77191_0_, var11, var18,
								var12)) {
