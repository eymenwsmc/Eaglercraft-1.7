...
public class RegionFileCache {
	...
	public static synchronized RegionFile createOrLoadRegionFile(VFile2 p_76550_0_, int p_76550_1_, int p_76550_2_) {
		VFile2 var3 = new VFile2(p_76550_0_, "region");
		VFile2 var4 = new VFile2(var3, "r." + (p_76550_1_ >> 5) + "." + (p_76550_2_ >> 5) + ".mca");
	 ...
	 * chunkZ
	 */
	public static DataInputStream getChunkInputStream(VFile2 p_76549_0_, int p_76549_1_, int p_76549_2_) {
	 ...
	 * chunkZ
	 */
	public static DataOutputStream getChunkOutputStream(VFile2 p_76552_0_, int p_76552_1_, int p_76552_2_) {
