...
public class RegionFile {
	...
	public RegionFile(VFile2 par1File) {
		...
		try {
			...
			this.dataFile = new RandomAccessFile(par1File.getName(), "rw");
			int var2;
	 ...
	 */
	public synchronized void write(int par1, int par2, byte[] par3ArrayOfByte, int par4) {
		try {
