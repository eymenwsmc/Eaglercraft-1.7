...
public class MapStorage {
	 ...
	 * instantiating the given Class, or returns null if none such VFile2 exists.
	...
	public WorldSavedData loadData(Class p_75742_1_, String p_75742_2_) {
		...
		if (var3 != null) {
			...
			if (this.saveHandler != null) {
				try {
					VFile2 var4 = this.saveHandler.getMapFileFromName(p_75742_2_);
	...
	private void saveData(WorldSavedData p_75747_1_) {
		if (this.saveHandler != null) {
			try {
				VFile2 var2 = this.saveHandler.getMapFileFromName(p_75747_1_.mapName);
				...
				if (var2 != null) {
					...
					CompressedStreamTools.writeCompressed(var4, var2.getOutputStream());
				}
	...
	/**
	 * Loads the idCounts Map from the 'idcounts' VFile2.
	 */
	private void loadIdCounts() {
		try {
			...
			VFile2 var1 = this.saveHandler.getMapFileFromName("idcounts");
	...
	public int getUniqueDataId(String p_75743_1_) {
		...
		if (this.saveHandler == null) {
			...
			try {
				VFile2 var3 = this.saveHandler.getMapFileFromName("idcounts");
