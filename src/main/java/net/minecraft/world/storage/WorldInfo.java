...
public class WorldInfo {
	 ...
	 * always prefer WorldProvider.dimensionID accessed from
	...
	public void addToCrashReport(CrashReportCategory p_85118_1_) {
		...
		p_85118_1_.addCrashSectionCallable("Level spawn location", new Callable() {
			...
			public String call() {
				return CrashReportCategory.getLocationInfo(WorldInfo.this.spawnX, WorldInfo.this.spawnY,
	...
	public boolean isOldRandom() {
		return false;
	}

	public boolean setDifficulty(net.minecraft.world.EnumDifficulty difficulty) {
		return difficulty == net.minecraft.world.EnumDifficulty.NORMAL;
	}
