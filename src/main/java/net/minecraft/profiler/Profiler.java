	...
	public List getProfilingData(String p_76321_1_) {
		if (!this.profilingEnabled) {
			...
			while (var10.hasNext()) {
				...
				if (var11.length() > p_76321_1_.length() && var11.startsWith(p_76321_1_)
						&& var11.indexOf(".", p_76321_1_.length() + 1) < 0) {
			...
			if ((float) var8 > var20) {
				var7.add(new Profiler.Result("unspecified", (double) ((float) var8 - var20) * 100.0D / (double) var8,
