...
public class EntityClientPlayerMP extends EntityPlayerSP {
	 ...
	 * 13) to the client at least once a second.
	 */
	...
	/**
	 * Force-close the GUI screen without sending a packet to the server, bypassing
	 * suppression. Intended for server-driven close events (e.g.,
	 * S2EPacketCloseWindow).
	 */
	public void forceCloseScreenNoPacket() {
		this.inventory.setItemStack((ItemStack) null);
		super.closeScreen();
	}
