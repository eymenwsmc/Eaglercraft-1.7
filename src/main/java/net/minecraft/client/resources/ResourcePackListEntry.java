...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry {
	...
	public void func_148279_a(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_,
		...
		if (var11 > 157) {
			var14 = this.field_148317_a.fontRenderer.trimStringToWidth(var14,
					157 - this.field_148317_a.fontRenderer.getStringWidth("...")) + "...";
		}
		...
		for (int var13 = 0; var13 < 2 && var13 < var12.size(); ++var13) {
			this.field_148317_a.fontRenderer.drawStringWithShadow((String) var12.get(var13), p_148279_2_ + 32 + 2,
	...
	protected boolean func_148314_g() {
		List var1 = this.field_148315_b.getListContaining(this);
	...
	public boolean func_148278_a(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_,
		...
		if (this.func_148310_d() && p_148278_5_ <= 32) {
			if (this.func_148309_e()) {
				this.field_148315_b.getListContaining(this).remove(this);
				this.field_148315_b.getSelectedResourcePacks().add(0, this);
			...
			if (p_148278_5_ < 16 && this.func_148308_f()) {
				this.field_148315_b.getListContaining(this).remove(this);
				this.field_148315_b.getAvailableResourcePacks().add(0, this);
				this.field_148315_b.markChanged();
				return true;
			}
			...
			if (p_148278_5_ > 16 && p_148278_6_ < 16 && this.func_148314_g()) {
				var7 = this.field_148315_b.getListContaining(this);
