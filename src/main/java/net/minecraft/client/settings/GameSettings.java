...
public class GameSettings {
	...
	public GameSettings(Minecraft p_i46326_1_, VFile2 p_i46326_2_) {
	...
	public float getOptionFloatValue(GameSettings.Options p_74296_1_) {
		return p_74296_1_ == GameSettings.Options.FOV ? this.fovSetting
		...
		if (p_74297_1_.getEnumFloat()) {
			...
			return p_74297_1_ == GameSettings.Options.SENSITIVITY
					...
					: (p_74297_1_ == GameSettings.Options.FOV
							? (var6 == 70.0F ? var2 + I18n.format("options.fov.min", new Object[0])
									: (var6 == 110.0F ? var2 + I18n.format("options.fov.max", new Object[0])
											: var2 + (int) var6))
							: (p_74297_1_ == GameSettings.Options.FRAMERATE_LIMIT
									? (var6 == p_74297_1_.valueMax
			...
			return var5 ? var2 + I18n.format("options.on", new Object[0])
			...
			while ((var2 = var1.readLine()) != null) {
				try {
					...
					if (var3[0].equals("resourcePacks")) {
						...
						try {
							JSONArray arr = new JSONArray(var3[1]);
							for (int i = 0; i < arr.length(); ++i) {
								this.resourcePacks.add(arr.getString(i));
							}
						} catch (Exception e) {
					...
					if (var3[0].equals("chatVisibility")) {
						this.chatVisibility = EntityPlayer.EnumChatVisibility
								.getEnumChatVisibility(Integer.parseInt(var3[1]));
					}
	...
	public void saveOptions() {
		try {
			...
			var1.println("resourcePacks:" + new JSONArray(this.resourcePacks).toString());
	...
	public static enum Options {
		...
		ANISOTROPIC_FILTERING("ANISOTROPIC_FILTERING", 32, "options.anisotropicFiltering", true, false, 1.0F, 16.0F,
				0.0F, null) {
		...
		private static final GameSettings.Options[] $VALUES = new GameSettings.Options[] { INVERT_MOUSE, SENSITIVITY,
				...
				CHAT_HEIGHT_UNFOCUSED, MIPMAP_LEVELS, ANISOTROPIC_FILTERING, FORCE_UNICODE_FONT, STREAM_BYTES_PER_PIXEL,
				STREAM_VOLUME_MIC, STREAM_VOLUME_SYSTEM, STREAM_KBPS, STREAM_FPS, STREAM_COMPRESSION,
				STREAM_SEND_METADATA, STREAM_CHAT_ENABLED, STREAM_CHAT_USER_FILTER, STREAM_MIC_TOGGLE_BEHAVIOR };
		...
		private Options(String p_i45004_1_, int p_i45004_2_, String p_i45004_3_, boolean p_i45004_4_,
				boolean p_i45004_5_, float p_i45004_6_, float p_i45004_7_, float p_i45004_8_) {
		...
		Options(String p_i45005_1_, int p_i45005_2_, String p_i45005_3_, boolean p_i45005_4_, boolean p_i45005_5_,
				float p_i45005_6_, float p_i45005_7_, float p_i45005_8_, Object p_i45005_9_) {
			this(p_i45005_1_, p_i45005_2_, p_i45005_3_, p_i45005_4_, p_i45005_5_, p_i45005_6_, p_i45005_7_,
					p_i45005_8_);
		}
	}
