...
public class ModelBiped extends ModelBase {
	...
	public ModelBiped(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_) {
		...
		int headwearU = (p_i1149_4_ == 64) ? 32 : 32;
		int headwearV = (p_i1149_4_ == 64) ? 0 : 0;
		this.bipedHeadwear = new ModelRenderer(this, headwearU, headwearV);
...
/**
 * Renders the cloak as a flat quad mapped to the full cape texture (64x32)
 * Option B: full-image mapping for custom capes
 */
public void renderCloak(float scale) {
    ...
    tes.addVertexWithUV(-5.0F * scale, 0.0F, 0.0F, 0.0D, 0.0D);
    tes.addVertexWithUV(5.0F * scale, 0.0F, 0.0F, 1.0D, 0.0D);
    tes.addVertexWithUV(5.0F * scale, 16.0F * scale, 0.0F, 1.0D, 1.0D);
    tes.addVertexWithUV(-5.0F * scale, 16.0F * scale, 0.0F, 0.0D, 1.0D);
    tes.draw();
