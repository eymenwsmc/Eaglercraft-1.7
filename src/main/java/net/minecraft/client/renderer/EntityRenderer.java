...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	public void onResourceManagerReload(IResourceManager p_110549_1_) {
		...
		try {
			...
			logger.warn("Failed to reinit lightmap after resource reload", t);
		} finally {
	...
	private void setupCameraTransform(float p_78479_1_, int p_78479_2_) {
		...
		GLU.gluPerspective(this.getFOVModifier(p_78479_1_, true),
	...
	private void renderHand(float p_78476_1_, int p_78476_2_) {
		if (this.debugViewDirection <= 0) {
			...
			GLU.gluPerspective(this.getFOVModifier(p_78476_1_, false),
					(float) this.mc.displayWidth / (float) this.mc.displayHeight, 0.05F, this.farPlaneDistance * 2.0F);
	...
	private void updateLightmap(float p_78472_1_) {
		...
		if (var2 != null) {
			for (int var3 = 0; var3 < 256; ++var3) {
				...
				this.lightmapColors[var3] = var20 << 24 | var23 << 16 | var22 << 8 | var21;
			}
	...
	public void renderWorld(float p_78471_1_, long p_78471_2_) {
		...
		for (int var13 = 0; var13 < 2; ++var13) {
			...
			var5.drawBlockDamageTexture(Tessellator.getInstance(), (EntityPlayer) var4, p_78471_1_);
			...
			if (false && this.mc.gameSettings.fancyGraphics) {
	 ...
	 */
	private net.lax1dude.eaglercraft.internal.buffer.FloatBuffer setFogColorBuffer(float p_78469_1_, float p_78469_2_,
			float p_78469_3_, float p_78469_4_) {
