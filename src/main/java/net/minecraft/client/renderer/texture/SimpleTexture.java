...
public class SimpleTexture extends AbstractTexture {
	...
	public void loadTexture(IResourceManager p_110551_1_) throws IOException {
		...
		try {
			...
			net.lax1dude.eaglercraft.opengl.ImageData var4 = net.lax1dude.eaglercraft.opengl.ImageData
					.loadImageFile(var2);
			boolean var5 = false;
			boolean var6 = false;
			...
			if (var3.hasMetadata()) {
				try {
					net.minecraft.client.resources.data.TextureMetadataSection var7 = (net.minecraft.client.resources.data.TextureMetadataSection) var3
							.getMetadata("texture");
			...
			net.minecraft.client.renderer.texture.TextureUtil.uploadTextureImageAllocate(texId, var4, var5, var6);
		} finally {
			if (var2 != null) {
				var2.close();
			}
