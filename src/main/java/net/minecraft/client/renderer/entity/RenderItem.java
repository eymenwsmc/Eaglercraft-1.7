...
public class RenderItem extends Render {
		...
		if (this.renderManager.options.fancyGraphics) {
			...
			for (int var20 = 0; var20 < var24; ++var20) {
				...
				if (var18.hasEffect()) {
					...
					this.func_77018_a(p_77020_4_ * 431278612 + p_77020_5_ * 32178161, p_77020_4_ - 2, p_77020_5_ - 2,
							20, 20);
					GL11.glDisable(GL11.GL_BLEND);
	...
	private void func_77018_a(float f, float g, float h, int par4, int par5) {
		for (int var6 = 0; var6 < 2; ++var6) {
			...
			var11.addVertexWithUV((double) (g + 0), (double) (h + par5), (double) this.zLevel,
					(double) ((var9 + (float) par5 * var12) * var7), (double) ((var10 + (float) par5) * var8));
			var11.addVertexWithUV((double) (g + par4), (double) (h + par5), (double) this.zLevel,
					(double) ((var9 + (float) par4 + (float) par5 * var12) * var7),
					(double) ((var10 + (float) par5) * var8));
			var11.addVertexWithUV((double) (g + par4), (double) (h + 0), (double) this.zLevel,
					(double) ((var9 + (float) par4) * var7), (double) ((var10 + 0.0F) * var8));
			var11.addVertexWithUV((double) (g + 0), (double) (h + 0), (double) this.zLevel,
	...
	public void renderItemIntoGUI(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_,
		...
		if (p_77015_3_.getItemSpriteNumber() == 0
			...
			if (var7 == null) {
				var7 = ((TextureMap) Minecraft.getMinecraft().getTextureManager().getTexture(var15))
	...
	public void renderItemAndEffectIntoGUI(FontRenderer p_82406_1_, TextureManager p_82406_2_,
		...
		if (p_82406_3_ != null) {
			...
			if (p_82406_3_.hasEffect()) {
				...
				this.renderGlint(0, p_82406_4_ - 2, p_82406_5_ - 2, 20, 20);

				GL11.glDepthMask(true);
				GL11.glDepthFunc(GL11.GL_LEQUAL);

				GL11.glEnable(GL11.GL_DEPTH_TEST);
				OpenGlHelper.glBlendFunc(770, 771, 1, 0);				GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
				GL11.glDisable(GL11.GL_BLEND);
				GL11.glEnable(GL11.GL_LIGHTING);

				ResourceLocation _atlas = p_82406_2_.getResourceLocation(p_82406_3_.getItemSpriteNumber());
				p_82406_2_.bindTexture(_atlas);
			}
