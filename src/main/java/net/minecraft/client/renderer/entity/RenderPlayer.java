...
public class RenderPlayer extends RendererLivingEntity {
	...
	public RenderPlayer() {
		super(new net.lax1dude.eaglercraft.profile.ModelPlayer(0.0F, false), 0.5F);
	...
	public void doRender(AbstractClientPlayer p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		if (this.modelBipedMain instanceof net.lax1dude.eaglercraft.profile.ModelPlayer) {
			net.lax1dude.eaglercraft.profile.ModelPlayer playerModel = (net.lax1dude.eaglercraft.profile.ModelPlayer) this.modelBipedMain;
			playerModel.setOverlayVisibility(true);
		}
	...
	protected void renderEquippedItems(AbstractClientPlayer p_77029_1_, float p_77029_2_) {
			...
			if (var3.getItem() instanceof ItemBlock) {
				...
				if (var3.hasTagCompound()) {
					...
					if (var6.func_150297_b("SkullOwner", 10)) {
						...
						var5 = new GameProfile((EaglercraftUUID) null, var6.getString("SkullOwner"));
					}
				}
		...
		if (var21 && !p_77029_1_.isInvisible() && !p_77029_1_.getHideCape()) {
			...
			if (this.modelBipedMain instanceof net.lax1dude.eaglercraft.profile.ModelPlayer) {
				((net.lax1dude.eaglercraft.profile.ModelPlayer) this.modelBipedMain).renderCape(0.0625F);
			} else {
