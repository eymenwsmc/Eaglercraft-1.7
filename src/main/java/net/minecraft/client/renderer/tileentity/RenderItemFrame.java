...
public class RenderItemFrame extends Render {
	...
	public void doRender(EntityItemFrame p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		GL11.glTranslatef((float) ((float) var16 - var10), (float) ((float) var17 - var12),
				(float) ((float) var18 - var14));
	...
	private void func_82402_b(EntityItemFrame p_82402_1_) {
		...
		if (var2 != null) {
			...
			if (var4 == Items.filled_map) {
				...
				if (var4 == Items.compass) {
					EaglerTextureAtlasSprite var13 = ((TextureMap) Minecraft.getMinecraft().getTextureManager()
