...
public class ActiveRenderInfo {
	...
	public static void updateRenderInfo(EntityPlayer p_74583_0_, boolean p_74583_1_) {
		...
		float[] objectCoordsArr = new float[3];
		modelview.position(0);
		modelview.get(modelviewArr);
		...
		GL11.gluUnProject(var2, var3, 0.0F, modelviewArr, projectionArr, viewport, objectCoordsArr);
		objectX = objectCoordsArr[0];
		objectY = objectCoordsArr[1];
		objectZ = objectCoordsArr[2];
