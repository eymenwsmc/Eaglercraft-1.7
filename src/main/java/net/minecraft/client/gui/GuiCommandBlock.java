...
public class GuiCommandBlock extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(this.field_146490_i = new GuiButton(0, this.width / 2 - 4 - 150, this.height / 4 + 120 + 12,
				150, 20, I18n.format("gui.done", new Object[0])));
		this.buttonList.add(this.field_146487_r = new GuiButton(1, this.width / 2 + 4, this.height / 4 + 120 + 12, 150,
