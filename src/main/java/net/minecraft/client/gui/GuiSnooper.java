...
public class GuiSnooper extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(this.field_146605_t = new GuiButton(1, this.width / 2 - 152, this.height - 30, 150, 20,
				this.field_146603_f.getKeyBinding(GameSettings.Options.SNOOPER_ENABLED)));
	...
	protected void actionPerformed(GuiButton p_146284_1_) {
		if (p_146284_1_.enabled) {
			...
			if (p_146284_1_.id == 1) {
				...
				this.field_146605_t.displayString = this.field_146603_f
	...
	class List extends GuiSlot {
		...
		protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_,
			...
			GuiSnooper.this.fontRendererObj.drawString((String) GuiSnooper.this.field_146604_g.get(p_148126_1_), 10,
					p_148126_3_, 16777215);
			GuiSnooper.this.fontRendererObj.drawString((String) GuiSnooper.this.field_146609_h.get(p_148126_1_), 230,
					p_148126_3_, 16777215);
		}
