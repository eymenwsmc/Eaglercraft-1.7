...
import net.eymenwsmc.GuiSupportedServers;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
	...
	public void func_146794_g() {
		...
		this.buttonList.add(new GuiButton(9, this.width / 2 - 154 - 102, this.height - 52, 100, 20,
				"Supported Servers"));
	...
	protected void actionPerformed(GuiButton p_146284_1_) {
		if (p_146284_1_.enabled) {
			...
			if (p_146284_1_.id == 2 && var2 instanceof ServerListEntryNormal) {
				...
				this.mc.displayGuiScreen(new GuiSupportedServers(this));
			}
		}
	}
	...
	public void setHoveringText(String s) {
		this.field_146812_y = s;
	}
	...
	public boolean func_175394_b(ServerListEntryNormal parServerListEntryNormal, int parInt1) {
		return parInt1 < this.field_146804_i.countServers() - 1;
	}
}
