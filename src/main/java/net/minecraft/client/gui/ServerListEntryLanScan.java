...
public class ServerListEntryLanScan implements GuiListExtended.IGuiListEntry {
	...
	public void func_148279_a(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_,
		...
		this.field_148288_a.fontRenderer.drawString(I18n.format("lanServer.scanning", new Object[0]),
				this.field_148288_a.currentScreen.width / 2 - this.field_148288_a.fontRenderer
		...
		this.field_148288_a.fontRenderer.drawString(var11,
				this.field_148288_a.currentScreen.width / 2
						- this.field_148288_a.fontRenderer.getStringWidth(var11) / 2,
				var10 + this.field_148288_a.fontRenderer.FONT_HEIGHT, 8421504);
	}
