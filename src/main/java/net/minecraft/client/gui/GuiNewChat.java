...
public class GuiNewChat extends Gui {
					...
					if (var10 != null) {
						...
						if (var11 < 200 || var3) {
							...
							if (var14 > 3) {
								...
								this.field_146247_f.fontRenderer.drawStringWithShadow(var17, var15, var16 - 8,
										16777215 + (var14 << 24));
							}
						}
					}
	...
	public IChatComponent func_146236_a(int p_146236_1_, int p_146236_2_) {
		if (!this.func_146241_e()) {
			...
			ScaledResolution var3 = new ScaledResolution(this.field_146247_f, this.field_146247_f.displayWidth,
					this.field_146247_f.displayHeight);
			...
			if (var6 >= 0 && var7 >= 0) {
				...
				if (var6 <= MathHelper.floor_float((float) this.func_146228_f() / this.func_146244_h())
						&& var7 < this.field_146247_f.fontRenderer.FONT_HEIGHT * var8 + var8) {
					...
					if (var9 >= 0 && var9 < this.field_146253_i.size()) {
						...
						while (var12.hasNext()) {
							...
							if (var13 instanceof ChatComponentText) {
								var11 += this.field_146247_f.fontRenderer.getStringWidth(this
	...
	public int func_146246_g() {
		return func_146243_b(this.func_146241_e() ? this.field_146247_f.gameSettings.chatHeightFocused
				: this.field_146247_f.gameSettings.chatHeightUnfocused);
	}
