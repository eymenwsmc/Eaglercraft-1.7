...
public class GuiAchievement extends Gui {
	...
	private void func_146258_c() {
		...
		ScaledResolution var1 = new ScaledResolution(this.field_146259_f, this.field_146259_f.displayWidth,
	...
	public void func_146254_a() {
		if (this.field_146266_k != null && this.field_146263_l != 0L && Minecraft.getMinecraft().thePlayer != null) {
			...
			this.field_146264_m.renderItemAndEffectIntoGUI(this.field_146259_f.fontRenderer,
					this.field_146259_f.getTextureManager(), this.field_146266_k.theItemStack, var5 + 8, var6 + 8);
			GL11.glDisable(GL11.GL_LIGHTING);
