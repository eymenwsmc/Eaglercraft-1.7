...
public class GuiScreenBook extends GuiScreen {
	...
	public void initGui() {
		...
		if (this.field_146475_i) {
			this.buttonList.add(this.field_146465_D = new GuiButton(3, this.width / 2 - 100, 4 + this.field_146477_v,
					98, 20, I18n.format("book.signButton", new Object[0])));
			this.buttonList.add(this.field_146472_C = new GuiButton(0, this.width / 2 + 2, 4 + this.field_146477_v, 98,
					20, I18n.format("gui.done", new Object[0])));
			this.buttonList.add(this.field_146467_E = new GuiButton(5, this.width / 2 - 100, 4 + this.field_146477_v,
					98, 20, I18n.format("book.finalizeButton", new Object[0])));
			this.buttonList.add(this.field_146469_F = new GuiButton(4, this.width / 2 + 2, 4 + this.field_146477_v, 98,
					20, I18n.format("gui.cancel", new Object[0])));
		} else {
			this.buttonList.add(this.field_146472_C = new GuiButton(0, this.width / 2 - 100, 4 + this.field_146477_v,
	...
	private void func_146464_h() {
		this.field_146470_A.visible = !this.field_146480_s
	...
	static class NextPageButton extends GuiButton {
		...
		public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
			if (this.visible) {
				...
				this.drawTexturedModalRect(this.buttonX, this.buttonY, var5, var6, 23, 13);
			}
		}
	}
}
