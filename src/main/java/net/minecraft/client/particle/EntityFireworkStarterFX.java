...
public class EntityFireworkStarterFX extends EntityFX {
	...
	public EntityFireworkStarterFX(World p_i46355_1_, double p_i46355_2_, double p_i46355_4_, double p_i46355_6_,
	...
	private boolean func_92037_i() {
		...
		return var1 == null || var1.renderViewEntity == null
				|| var1.renderViewEntity.getDistanceSq(this.posX, this.posY, this.posZ) >= 256.0D;
	}
