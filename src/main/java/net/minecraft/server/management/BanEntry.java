...
public abstract class BanEntry extends UserListEntry {
	...
	protected BanEntry(Object p_i1174_1_, JSONObject p_i1174_2_) {
		...
		try {
			var3 = p_i1174_2_.has("created") ? dateFormat.parse(p_i1174_2_.get("created").toString()) : new Date();
		} catch (ParseException var7) {
			var3 = new Date();
		}

		this.banStartDate = var3;
		this.bannedBy = p_i1174_2_.has("source") ? p_i1174_2_.get("source").toString() : "(Unknown)";
		Date var4;

		try {
			var4 = p_i1174_2_.has("expires") ? dateFormat.parse(p_i1174_2_.get("expires").toString()) : null;
		} catch (ParseException var6) {
			var4 = null;
		}

		this.banEndDate = var4;
		this.reason = p_i1174_2_.has("reason") ? p_i1174_2_.get("reason").toString() : "Banned by an operator.";
	}
	...
	protected void func_152641_a(JSONObject p_152641_1_) {
		p_152641_1_.append("created", dateFormat.format(this.banStartDate));
		p_152641_1_.append("source", this.bannedBy);
		p_152641_1_.append("expires", this.banEndDate == null ? "forever" : dateFormat.format(this.banEndDate));
		p_152641_1_.append("reason", this.reason);
	}
}
