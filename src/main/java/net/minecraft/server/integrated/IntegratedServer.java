...
public class IntegratedServer extends MinecraftServer {
	...
	public IntegratedServer(Minecraft p_i1317_1_, String p_i1317_2_, String p_i1317_3_, WorldSettings p_i1317_4_) {
		...
		super(new VFile2(p_i1317_1_.mcDataDir, "saves"), null);
		...
		for (int var8 = 0; var8 < this.worldServers.length; ++var8) {
			...
			if (var8 == 0) {
				if (this.isDemo()) {
					...
					this.worldServers[var8] = new WorldServer(this, var7, p_71247_2_, var9, this.theWorldSettings,
							this.theProfiler);
				}
			} else {
			}
	...
	public void tick() {
		...
		this.isGamePaused = Minecraft.getMinecraft().getNetHandler() != null
