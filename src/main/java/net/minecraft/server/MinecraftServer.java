...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage {
	...
	public MinecraftServer(VFile2 p_i46400_1_, Proxy p_i46400_2_) {
	...
	protected void outputPercentRemaining(String p_71216_1_, int p_71216_2_) {
		...
		EaglerIntegratedServerWorker.sendProgress("singleplayer.busy.startingIntegratedServer", p_71216_2_ * 0.01f);
	}
	...
	public void run() {
		try {
			...
			VFile2 var3 = new VFile2(new VFile2(this.getDataDirectory(), "crash-reports"),
	...
	protected VFile2 getDataDirectory() {
		return new VFile2(".");
	}
	 ...
	 */
	public VFile2 getFile(String p_71209_1_) {
		return new VFile2(this.getDataDirectory(), p_71209_1_);
	}
