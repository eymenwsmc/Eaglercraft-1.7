...
public class NetHandlerHandshakeTCP implements INetHandlerHandshakeServer {
	...
	private final IntegratedServerPlayerNetworkManager field_147386_b;
	private static final String __OBFID = "CL_00001456";

	public NetHandlerHandshakeTCP(MinecraftServer p_i45295_1_, IntegratedServerPlayerNetworkManager p_i45295_2_) {
	...
	public void processHandshake(C00Handshake p_147383_1_) {
		...
		case 1:
			...
			if (p_147383_1_.func_149595_d() > 5) {
				...
				this.field_147386_b.sendPacket(new S00PacketDisconnect(var2));
