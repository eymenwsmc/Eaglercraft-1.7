...
public class NetHandlerStatusServer implements INetHandlerStatusServer {
	...
	private final IntegratedServerPlayerNetworkManager field_147313_b;
	private static final String __OBFID = "CL_00001464";

	public NetHandlerStatusServer(MinecraftServer p_i45299_1_, IntegratedServerPlayerNetworkManager p_i45299_2_) {
	...
	public void processServerQuery(C00PacketServerQuery p_147312_1_) {
		this.field_147313_b.sendPacket(new S00PacketServerInfo(this.field_147314_a.func_147134_at()));
	}

	public void processPing(C01PacketPing p_147311_1_) {
		this.field_147313_b.sendPacket(new S01PacketPong(p_147311_1_.func_149289_c()));
	}
}
