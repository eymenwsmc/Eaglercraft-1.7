...
public class BlockSilverfish extends Block {
	...
	public static Tuple func_150197_b(int p_150197_0_) {
		switch (p_150197_0_) {
		case 1:
			return new Tuple(Blocks.cobblestone, Integer.valueOf(0));

		case 2:
			return new Tuple(Blocks.stonebrick, Integer.valueOf(0));

		case 3:
			return new Tuple(Blocks.stonebrick, Integer.valueOf(1));

		case 4:
			return new Tuple(Blocks.stonebrick, Integer.valueOf(2));

		case 5:
			return new Tuple(Blocks.stonebrick, Integer.valueOf(3));

		default:
			return new Tuple(Blocks.stone, Integer.valueOf(0));
		}
	}
