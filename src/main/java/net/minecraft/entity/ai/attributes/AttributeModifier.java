...
public class AttributeModifier {
	...
	public AttributeModifier(String p_i1605_1_, double p_i1605_2_, int p_i1605_4_) {
		this(EaglercraftUUID.randomUUID(), p_i1605_1_, p_i1605_2_, p_i1605_4_);
	}

	public AttributeModifier(EaglercraftUUID p_i1606_1_, String p_i1606_2_, double p_i1606_3_, int p_i1606_5_) {
		this.isSaved = true;
		this.id = p_i1606_1_;
