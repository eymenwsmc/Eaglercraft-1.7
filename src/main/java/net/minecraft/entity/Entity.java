...
public abstract class Entity {
	...
	public Entity(World p_i1582_1_) {
		...
		this.entityUniqueID = EaglercraftUUID.randomUUID();
	...
	public void readFromNBT(NBTTagCompound p_70020_1_) {
		try {
			...
			if (p_70020_1_.func_150297_b("UUIDMost", 4) && p_70020_1_.func_150297_b("UUIDLeast", 4)) {
				this.entityUniqueID = new EaglercraftUUID(p_70020_1_.getLong("UUIDMost"),
	...
	public static enum EnumEntitySize {
		SIZE_1("SIZE_1", 0), SIZE_2("SIZE_2", 1), SIZE_3("SIZE_3", 2), SIZE_4("SIZE_4", 3), SIZE_5("SIZE_5", 4),
		SIZE_6("SIZE_6", 5);
