...
public abstract class EntityLiving extends EntityLivingBase {
	...
	public void faceEntity(Entity p_70625_1_, float p_70625_2_, float p_70625_3_) {
		...
		if (p_70625_1_ instanceof EntityLivingBase) {
			...
			var6 = (p_70625_1_.boundingBox.minY + p_70625_1_.boundingBox.maxY) / 2.0D
	 ...
	 * tethered to.\n@param par2: Whether to send an attaching notification packet
	...
	private void recreateLeash() {
		if (this.isLeashed && this.field_110170_bx != null) {
			if (this.field_110170_bx.func_150297_b("UUIDMost", 4)
				...
				EaglercraftUUID var5 = new EaglercraftUUID(this.field_110170_bx.getLong("UUIDMost"),
						this.field_110170_bx.getLong("UUIDLeast"));
				List var6 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
