...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender {
	...
	public static EaglercraftUUID func_146094_a(GameProfile p_146094_0_) {
		EaglercraftUUID var1 = p_146094_0_.getId();

		if (var1 == null) {
			var1 = EaglercraftUUID
					.nameUUIDFromBytes(("OfflinePlayer:" + p_146094_0_.getName()).getBytes(Charsets.UTF_8));
		}
	...
	public static enum EnumChatVisibility {
		FULL("FULL", 0, 0, "options.chat.visibility.full"), SYSTEM("SYSTEM", 1, 1, "options.chat.visibility.system"),
	...
	public static enum EnumStatus {
		OK("OK", 0), NOT_POSSIBLE_HERE("NOT_POSSIBLE_HERE", 1), NOT_POSSIBLE_NOW("NOT_POSSIBLE_NOW", 2),
