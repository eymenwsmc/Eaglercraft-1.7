...
public class Color implements java.io.Serializable {
	 ...
	 * <code>float</code> components (no alpha). If <code>null</code> after object
	...
	/**
	 * The color value in the native <code>ColorSpace</code> as <code>float</code>
	 * components (no alpha). If <code>null</code> after object construction, this
	 * must be an sRGB color constructed with 8-bit precision, so compute from the
	...
	/**
	 * The alpha value as a <code>float</code> component. If <code>frgbvalue</code>
	...
	/**
	 * Checks the color <code>float</code> components supplied for validity. Throws
	 * an <code>IllegalArgumentException</code> if the value is out of range.
	 * 
	 * @param r the Red component
	 * @param g the Green component
	 * @param b the Blue component
	 ...
	 * 
	 * @param nm a <code>String</code> that represents an opaque color as a 24-bit
	 *           integer
	 ...
	 * which is then converted to a <code>Color</code> object.
	 * <p>
	 * If the specified property is not found or cannot be parsed as an integer then
	 * the <code>Color</code> specified by the second argument is returned instead.
	 * 
	 * @param nm the name of the color property
	 ...
	 * <p>
	 * If the specified property is not found or could not be parsed as an integer
	 * then the integer value <code>v</code> is used instead, and is converted to a
	 ...
	 * @return a <code>Color</code> object with the specified hue, saturation, and
	 *         brightness.
	 * @since JDK1.0
	 */
	...
	/**
	 * Returns a <code>float</code> array containing the color and alpha components
	...
	/**
	 * Returns a <code>float</code> array containing only the color components of
	...
	/**
	 * Returns the transparency mode for this <code>Color</code>. This is required
	 * to implement the <code>Paint</code> interface.
	 * 
